...
const Hospitality = () => {
     const {
        ...
        const title = "Commercial & Hospitality Essentials";
        const description = "Explore our top-rated products designed for commercial and hospitality spaces. Crafted for durability, style, and functionality";
  ...
  title="Elevating"
  highlight="Hospitality & Restaurant Spaces"
  subtitle="Innovative Designs to Create Unforgettable Experiences"
  buttonText="Discover Upgrades"
  buttonLink="/hospitality-restaurant-upgrades"
/>
      <ProductSection
        title={title}
