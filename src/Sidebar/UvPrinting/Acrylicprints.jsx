...
const Acrylicprints = () => {
  ...
  const title = "Acrylic Prints Collection";  
  const description = "Explore our stunning acrylic prints, crafted for vibrant colors, durability, and a modern aesthetic. Elevate your space with high-quality, glossy artwork that makes a statement!"  
...
<Hero
  ...
  highlight="Acrylic Prints"
  subtitle="Crystal Clear, Vibrant & Durable Prints"
  buttonText="Discover More"
  buttonLink="/uv-printing/acrylic-prints"
/>
