...
const Decorative = () => {
  ...
  const title = "Decorative Collection";  
  const description = "Enhance your space with our exquisite decorative pieces. From elegant accents to modern designs, discover top-rated decor items that bring style, charm, and personality to any setting!"  
  
return (
<>
<div >
<Hero
  image="/Images/Exclusive6.jpeg" // Directly reference the image path
  title="Stylish & Functional"
  highlight="Decorative Panels"
  subtitle="Elevate Interiors with Exquisite Printed Panels"
  buttonText="See More"
  buttonLink="/uv-printing/decorative-panels"
/>
