...
const Luxary = () => {
  ...
  const title = "Luxury Renovation Services";  
  const description = "Redefine elegance with our high-end renovation services. Experience premium materials, sophisticated designs, and top-tier craftsmanship tailored to your luxurious lifestyle."  
...
<Hero
  ...
  highlight="Luxury Interior Makeovers"
  subtitle="Elegant & Timeless Designs for a Premium Lifestyle"
  buttonText="Explore Designs"
  buttonLink="/luxury-interior-makeover"
/>
<ProductSection
title={title}
