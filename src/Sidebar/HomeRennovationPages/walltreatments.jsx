...
const Walltreatments = () => {
  ...
  const title = "Wall Treatment & Design";  
  const description = "Enhance your interiors with stunning wall treatments. From textured finishes to decorative panels, we offer creative solutions to add depth and style to your walls."  
...
<Hero
  ...
  title="Elegant"
  highlight="Wall Treatments & Decor"
  subtitle="Creative & Stylish Wall Solutions for Every Room"
  buttonText="See Inspirations"
  buttonLink="/wall-treatments-decor"
/>
<ProductSection
title={title}
