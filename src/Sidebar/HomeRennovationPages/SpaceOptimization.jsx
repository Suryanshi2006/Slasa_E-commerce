...
const SpaceOptimization = () => {
  ...
  const title = "Space Optimization Solutions";  
  const description = "Maximize your space with innovative design and smart storage solutions. Our space optimization services help create functional, stylish, and clutter-free environments."  
  
return (
<>
<div className='container mx-auto'>
<Hero
  image="/Images/HeroRenoovation.jpeg"
  title="Maximizing"
  highlight="Space Optimization & Partitioning"
  subtitle="Innovative Solutions to Enhance Functionality "
  buttonText="View Solutions"
  buttonLink="/space-optimization-partitioning"
/>
<ProductSection
title={title}
