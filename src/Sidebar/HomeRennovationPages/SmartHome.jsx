...
const SmartHome = () => {
  ...
  const title = "Smart Home Renovation";  
  const description = "Upgrade your living space with cutting-edge smart home solutions. Integrate automation, energy efficiency, and security to create a futuristic and convenient home experience."  
...
<Hero
  ...
  title="Seamless"
  highlight="Smart Home Integration"
  subtitle="Advanced Technology for a Smarter, More Efficient Home"
  buttonText="Discover More"
  buttonLink="/smart-home-integration"
/>
<ProductSection
title={title}
