...
const EventSetup = () => {
  ...
  const title = "Exclusive Events & Showcases";  
  const description = "Stay updated on our latest events, product launches, and special showcases. Explore industry-leading innovations and experience our top-rated products in action!"  
