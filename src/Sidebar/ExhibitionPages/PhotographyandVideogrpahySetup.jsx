...
const PhotographyandVideogrpahySetup = () => {
    const {
        voucherData,
        constructionVoucher,
        homepageVouchers,
      ...
      const title = "Premium Advertisements";  
      const description = "Showcase your brand with our top-rated advertising solutions. Engage your audience with high-quality visuals, compelling messaging, and impactful promotions tailored for success!"  
...
export default PhotographyandVideogrpahySetup
