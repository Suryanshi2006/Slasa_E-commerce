...
const FloorDesigning = () => {
  ...
  const title = "Floor Designing Solutions";  
  const description = "Transform your space with our top-rated floor designing solutions. Discover stylish, durable, and high-quality flooring options to elevate any interior effortlessly!"  
