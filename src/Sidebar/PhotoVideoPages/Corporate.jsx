...
const Corporate = () => {
  ...
  const title = "Corporate Photography & Videography";  
  const description = "Capture the essence of your brand with professional corporate photography and videography. Elevate your business image with high-quality visuals tailored for success!"  
  
return (
<>
<div >
<Hero
  image="/Images/Corporate1.avif"
  title="Refining"
  highlight="Your Corporate Image"
  subtitle="Professional Corporate Shoots to Elevate Your Brand"
  buttonText="Explore Services"
  buttonLink="/corporate-shoots"
/>
<ProductSection
title={title}
