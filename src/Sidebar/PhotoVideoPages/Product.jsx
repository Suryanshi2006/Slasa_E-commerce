...
const Product = () => {
  ...
  const title = "Product Photography & Videography";  
  const description = "Showcase your products in the best light with our professional photography and videography services. Perfect for e-commerce, catalogs, and advertisements!"  
...
<Hero
  ...
  title="Showcasing"
  highlight="Your Products with Perfection"
  subtitle="High-Quality Product Photography for Maximum Impact"
  buttonText="See Our Work"
  buttonLink="/product-photography"
/>
<ProductSection
title={title}
