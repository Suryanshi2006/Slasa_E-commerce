...
const SpecialVideo = () => {
  ...
  const title = "Special Videography Services";  
  const description = "Create unforgettable visual stories with our specialty videography services. Whether it's artistic, documentary, or cinematic projects, we bring your vision to life!"  
...
<Hero
  ...
  subtitle="Tailored Video Solutions for Special Requirements"
  buttonText="Get in Touch"
  buttonLink="/special-videography"
/>
<ProductSection
title={title}
