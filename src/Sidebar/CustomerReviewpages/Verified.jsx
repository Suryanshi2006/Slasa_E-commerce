...
const Verified = () => {
      const {
                  ...
                  const title = "Verified Customer Testimonials";  
                  const description = "Hear from our satisfied customers! Read authentic reviews and success stories about our top-rated products, trusted for their quality, durability, and style."  
  ...
  subtitle="Real Stories, Real Experiences, Real Satisfaction"
