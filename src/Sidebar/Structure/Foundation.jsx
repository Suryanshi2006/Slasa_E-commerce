...
const Foundation = () => {
  ...
  const title = "Foundation & Concrete Works";  
  const description = "Build with strength and precision! Explore our expert foundation and concrete services, ensuring durability, stability, and quality for every construction project."  
...
<Hero
  ...
  highlight="Foundation & Concrete Works"
  subtitle="Strong Foundations for Lasting Structures"
  buttonText="Explore Services"
  buttonLink="/foundation-concrete-works"
/>
<ProductSection
title={title}
