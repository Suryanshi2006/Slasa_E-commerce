...
const Masonry = () => {
  ...
  const title = "Masonry & Brickwork Solutions";  
  const description = "Discover top-quality masonry and brickwork solutions designed for strength, durability, and aesthetic appeal. Build with precision and style for lasting structures!"  
...
<Hero
  ...
  title="Expert"
  highlight="Masonry & Brickwork"
  subtitle="Precision Craftsmanship for Durable Constructions"
  buttonText="View Projects"
  buttonLink="/masonry-brickwork"
/>
<ProductSection
title={title}
