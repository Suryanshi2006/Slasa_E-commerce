...
const SpecialityPrinting = () => {
  ...
  const title = "Specialty Printing Solutions";  
  const description = "Stand out with our specialty printing services! From foil stamping to embossing and UV coatings, add a touch of luxury and uniqueness to your prints."  
...
<Hero
  ...
  title="Exquisite"
  highlight="Specialty Printing"
  subtitle="Custom Finishes to Make Your Prints Stand Out"
  buttonText="See Options"
  buttonLink="/specialty-printing"
/>
<ProductSection
title={title}
...
export default SpecialityPrinting
