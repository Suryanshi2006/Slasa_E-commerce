...
const CustomPrinting = () => {
  ...
  const title = "Custom Printing Services";  
  const description = "Bring your ideas to life with our high-quality custom printing services. From personalized designs to unique branding solutions, we ensure precision and excellence in every print!"  
  
return (
<>
<div className='container mx-auto'>
<Hero
  image="/Images/print4.avif"
  title="Tailored"
  highlight="Personalized & Custom Printing"
  subtitle="Create Unique Designs That Reflect Your Brand"
  buttonText="Customize Now"
  buttonLink="/custom-printing"
/>
<ProductSection
title={title}
