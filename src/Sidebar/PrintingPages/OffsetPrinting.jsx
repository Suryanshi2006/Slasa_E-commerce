...
const OffsetPrinting = () => {
  ...
  const title = "Offset Printing Services";  
  const description = "Get premium-quality offset printing for bulk orders with sharp details and rich colors. Perfect for brochures, business cards, packaging, and more!"  
...
<Hero
  ...
  title="Precision in"
  highlight="Offset Printing"
  subtitle="Bulk Printing Solutions with Unmatched Quality"
  buttonText="Learn More"
  buttonLink="/offset-printing"
/>
<ProductSection
title={title}
