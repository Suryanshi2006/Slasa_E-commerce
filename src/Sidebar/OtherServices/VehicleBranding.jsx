...
const VehicleBranding = () => {
  ...
  const title = "Vehicle Branding & Graphics";  
  const description = "Turn your vehicles into moving billboards with our custom branding solutions! High-quality wraps and graphics designed for maximum visibility and brand impact."  
  
return (
<>
<div className='container mx-auto'>
<Hero
  image="/Images/branding.avif"
  title="Dynamic"
  highlight="Vehicle Branding"
  subtitle="Turn Your Vehicles into Powerful Marketing Tools"
