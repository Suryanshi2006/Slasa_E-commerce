...
const SafetyEquipements = () => {
  ...
  const title = "Safety Equipment & Supplies";  
  const description = "Ensure workplace safety with our premium safety equipment and supplies. From protective gear to signage, we provide reliable solutions for all industries."  
  
return (
<>
<div className='container mx-auto'>
<Hero
  image="/Images/safety.avif"
  title="Essential"
  highlight="Safety Equipment"
  subtitle="Protective Gear & Safety Solutions for Every Industry"
  buttonText="Shop Now"
  buttonLink="/safety-equipments"
/>
<ProductSection
title={title}
...
export default SafetyEquipements
