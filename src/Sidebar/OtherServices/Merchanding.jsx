...
const Merchanding = () => {
  ...
  const title = "Merchandising & Promotional Products";  
  const description = "Boost your brand with custom merchandising solutions! From apparel to promotional giveaways, we provide high-quality branded products to leave a lasting impression."  
...
<Hero
  ...
  title="Smart"
  highlight="Merchandising Stands"
  subtitle="Creative Product Display Solutions for Retail"
  buttonText="Check Designs"
  buttonLink="/merchandising-stands"
/>
<ProductSection
title={title}
