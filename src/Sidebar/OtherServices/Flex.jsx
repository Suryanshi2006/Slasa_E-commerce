...
const Flex = () => {
  ...
  const title = "Flex Printing & Signage";  
  const description = "Get vibrant, durable flex prints for banners, hoardings, and signage. Perfect for outdoor and indoor advertising with long-lasting quality."  
  
return (
<>
<div >
<Hero
  image="/Images/HeroFlexFaceSignange.jpg"
  title="Durable"
  highlight="Flex Face Signage"
  subtitle="Weather-Resistant, Large-Scale Signage Solutions"
  buttonText="Get Started"
  buttonLink="/flex-face-signage"
/>
<ProductSection
title={title}
