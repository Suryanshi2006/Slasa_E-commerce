...
const LedNeon = () => {
  ...
  const title = "Custom LED Neon Signs";  
  const description = "Light up your space with our custom LED neon signs! Perfect for businesses, events, and home décor, designed for a modern and eye-catching glow."  
  
return (
<>
<div className='container mx-auto'>
<Hero
  image="/Images/HeroLEDNeonSignage.avif"
  title="Vibrant"
  highlight="LED & Neon Signage"
  subtitle="Bright & Custom Neon Signs "
  buttonText="Customize Now"
  buttonLink="/led-neon-signage"
/>
<ProductSection
title={title}
