...
const StreetSigns = () => {
  ...
  const title = "Street Signs & Traffic Solutions";  
  const description = "Enhance road safety and navigation with our high-quality street signs and traffic solutions. Designed for durability, visibility, and compliance with safety standards."  
...
<Hero
  ...
  title="Visible"
  highlight="Street Signs"
  subtitle="High-Quality Road & Directional Signage"
  buttonText="View Collection"
  buttonLink="/street-signs"
/>
<ProductSection
title={title}
