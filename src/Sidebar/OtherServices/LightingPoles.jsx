...
const LightingPoles = () => {
  ...
  const title = "Lighting Poles & Fixtures";  
  const description = "Illuminate streets, parking lots, and public spaces with our high-quality lighting poles and fixtures. Durable, efficient, and built for all-weather performance."  
...
<Hero
  ...
  subtitle="High-Quality Poles for Streets, Parks & Public Spaces"
  buttonText="View Options"
  buttonLink="/lighting-poles"
/>
<ProductSection
title={title}
