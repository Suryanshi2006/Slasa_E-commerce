...
const Kitchen = () => {
  ...
  const title = "Kitchen Renovation Services";  
  const description = "Upgrade your kitchen with modern designs, high-quality materials, and smart functionality. From custom cabinetry to full remodels, we bring your dream kitchen to life!"  
...
<Hero
  ...
  highlight="Kitchen Remodeling"
  subtitle="Upgrade Your Kitchen with Stylish"
  buttonText="Explore Designs"
  buttonLink="/kitchen-remodeling"
/>
<ProductSection
title={title}
