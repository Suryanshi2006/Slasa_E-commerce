...
const Energy = () => {
  ...
  const title = "Energy-Efficient Upgrades";  
  const description = "Upgrade your home or office with energy-efficient solutions. Reduce costs, enhance sustainability, and improve comfort with the latest eco-friendly innovations."  
...
<Hero
  ...
  subtitle="Eco-Friendly Solutions to Reduce Energy Costs"
  buttonText="Go Green"
  buttonLink="/energy-efficient-upgrades"
/>
<ProductSection
title={title}
