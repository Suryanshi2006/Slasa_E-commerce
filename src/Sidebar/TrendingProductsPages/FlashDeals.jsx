...
const FlashDeals = () => {
  ...
  const description = "Don't miss out on our limited-time flash deals! Grab top-rated products at unbeatable prices before the time runs out. Shop now and save big!"  
