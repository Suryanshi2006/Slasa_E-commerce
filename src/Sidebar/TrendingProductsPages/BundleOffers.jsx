...
const BundleOffers = () => {
  ...
  const title = "Exclusive Bundle Offers";  
  const description = "Get the best value with our exclusive bundle offers! Discover top-rated product combinations at unbeatable prices—perfect for maximizing savings without compromising on quality and style."  
