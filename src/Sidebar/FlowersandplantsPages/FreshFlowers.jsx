...
const FreshFlowers = () => {
  ...
  const title = "Fresh Flower Collection";  
  const description = "Brighten up any space with our handpicked fresh flowers. Perfect for gifts, events, or home décor, our blooms bring beauty and elegance to every occasion."  
