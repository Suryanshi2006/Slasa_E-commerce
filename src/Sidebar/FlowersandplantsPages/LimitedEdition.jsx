...
const LimitedEdition = () => {
  ...
  const title = "Exclusive Limited Edition Collection";  
  const description = "Discover our rare and exclusive limited-edition products. Uniquely crafted and available for a short time only—grab them before they're gone!"  
