...
const IndoorPlants = () => {
  ...
  const title = "Indoor Plants for Every Space";  
  const description = "Enhance your interiors with lush, air-purifying indoor plants. Explore our collection of low-maintenance and stylish greenery to bring nature inside."  
