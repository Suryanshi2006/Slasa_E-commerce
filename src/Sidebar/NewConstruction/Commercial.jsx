...
const Commercial = () => {
  ...
  const title = "Commercial Construction Services";  
  const description = "Build with confidence using our professional commercial construction solutions. We specialize in high-quality, efficient, and innovative building projects."  
...
<Hero
  ...
  title="Reliable"
  highlight="Commercial & Industrial Construction"
  subtitle="Efficient & High-Quality Construction for Businesses"
  buttonText="View Services"
  buttonLink="/commercial-industrial-construction"
/>
<ProductSection
title={title}
