...
const Ceiling = () => {
  ...
  const title = "Ceiling Construction Solutions";  
  const description = "Upgrade your spaces with our expert ceiling construction services. From suspended ceilings to custom designs, we ensure durability, aesthetics, and functionality."  
...
<Hero
  ...
  title="Elegant"
  highlight="Lighting & Ceiling Design"
  subtitle=" Functional Lighting Solutions for Any Space"
  buttonText="Browse Designs"
  buttonLink="/lighting-ceiling-design"
/>
<ProductSection
title={title}
