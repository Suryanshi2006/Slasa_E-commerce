...
const Outdoor = () => {
  ...
  const title = "Outdoor Construction & Landscaping";  
  const description = "Transform outdoor spaces with our premium construction services. From patios to public parks, we create durable, weather-resistant, and aesthetically pleasing environments."  
...
<Hero
  ...
  title="Enhancing"
  highlight="Landscaping & Outdoor Structures"
  subtitle="Creating Beautiful Outdoor Spaces"
  buttonText="See Designs"
  buttonLink="/landscaping-outdoor-structures"
/>
<ProductSection
title={title}
