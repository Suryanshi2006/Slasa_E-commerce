...
const Office = () => {
  ...
  const title = "Office Maintenance Services";  
  const description = "Maintain a productive workspace with our specialized office maintenance solutions. We offer cleaning, repairs, and upkeep to ensure a professional environment."  
