...
const Specialized = () => {
  ...
  const title = "Specialized Maintenance Services";  
  const description = "Get expert maintenance solutions tailored to your specific needs. From high-tech equipment to industry-specific facilities, we ensure optimal performance and longevity."  
