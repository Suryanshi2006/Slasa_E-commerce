...
const Facility = () => {
  ...
  const title = "Facility Maintenance Services";  
  const description = "Ensure smooth operations with our comprehensive facility maintenance solutions. From routine inspections to emergency repairs, we keep your infrastructure in top shape."  
