...
const Handmade = () => {
  ...
  const title = "Handmade Creations";  
  const description = "Discover our exquisite handmade products, crafted with passion and precision. Unique designs, high-quality materials, and a touch of artistry in every piece!"  
...
<Hero
  ...
  title="Artisanal"
  highlight="Handmade Acrylic Creations"
  subtitle="Crafted with Passion & Precision"
  buttonText="Explore Now"
  buttonLink="/new-arrivals/handmade"
/>
